<div class="container mx-auto">
    <div class="pt-20 flex justify-center">
        ...
        <div class="mr-2 ml-2">    
            <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" id="open_modal_add_list">ADD LIST</button>
        </div>
    </div>
</div>
